#!/usr/bin/env bash
# run_experiments_medium_goal.sh
#
...
# Plan:    generated on run 1, saved to output/eval_with_embeddings/medium_goal/run_1/test_plan.yaml
# Outputs: output/eval_with_embeddings/medium_goal/run_1 … run_10
# Results: output/eval_with_embeddings/medium_goal/eval_run_rows.jsonl

set -euo pipefail

URL="https://work.toqan.ai/"
PERSONAS="./output/similarity_run/personas.json"
EXPERIMENTS_DIR="./output/eval_with_embeddings/medium_goal"
GOAL="test the creation of a RAG agent, using startup_handbook.pdf"
