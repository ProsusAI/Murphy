#!/usr/bin/env bash
# run_experiments_simple_goal.sh
#
# Runs the saved test plan 10 times using discovered personas.
# Goal:    "test the agent creation functionality"
# Plan:    generated on run 1, saved to output/eval_with_embeddings/simple_goal/run_1/test_plan.yaml
# Outputs: output/eval_with_embeddings/simple_goal/run_1 … run_10
# Results: output/eval_with_embeddings/simple_goal/eval_run_rows.jsonl

set -euo pipefail

URL="https://work.toqan.ai/"
PERSONAS="./output/similarity_run/personas.json"
EXPERIMENTS_DIR="./output/eval_with_embeddings/simple_goal"
GOAL="test the agent creation functionality"
